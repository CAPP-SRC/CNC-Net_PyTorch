...
def save_model_parameters(experiment_directory, filename, decoder, opt, epoch):
...
def load_model_parameters(experiment_directory, checkpoint, decoder, opt):
...
def save_model_parameters_per_shape(experiment_directory, shapename, filename, decoder, shape_code, opt, epoch):
...
def load_model_parameters_per_shape(experiment_directory, shapename, checkpoint, decoder, opt):
